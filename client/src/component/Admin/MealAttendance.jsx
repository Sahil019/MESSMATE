...
const AdminMealAttendance = () => {
  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const attData = await api(`/api/attendance?startDate=${selectedDate}&endDate=${selectedDate}`);
      if (!attData.ok && !attData.success) throw new Error('Failed to fetch attendance');
